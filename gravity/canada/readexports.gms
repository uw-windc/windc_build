...
*	https://www150.statcan.gc.ca/n1/pub/71-607-x/2021004/exp-eng.htm?r1=(10,11,12,13,24,35,46,47,48,59,60,61,62)&r2=9&r3=0&r4=0&r5=1&r7=1&r8=2017-01-01&r9=2017-12-01
...
$call csv2gdx exports.csv id=trade useheader=yes index=(1,3,5) values=(6,7) o=usatrade.gdx
$call csv2gdx exports.csv id=r_hs6   useheader=yes autorow=r index=(1) text=2 o=hs6.gdx
$call csv2gdx exports.csv id=r_units useheader=yes autorow=r index=(1,8) o=units.gdx
