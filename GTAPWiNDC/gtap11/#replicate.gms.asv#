...
$prod:Y(g,r)$vom(g,r) s:0 m:esub(g) va:esubva(g) 
...
$prod:Z(i,r)  s:esubdm(i)
	o:PA(i,r)	q:(sum(g,vafm(i,g,r)))
	i:P(i,r)	q:(sum(g,vdfm(i,g,r)))	p:(1+rtfd0(i,g,r)) i.tl:  a:RA(r) t:rtfd_ave(i,r)
	i:PM(i,r)	q:(sum(g,vifm(i,g,r)))	p:(1+rtfi0(i,g,r)) i.tl:  a:RA(r) t:rtfi_ave(i,r)
