...
nz("vst","gtap11a") = card(vst);
nz("vtwr","gtap11a") = card(vtwr);
nz("vxmd","gtap11a") = card(vxmd);
nz("vdfm","gtap11a") = card(vdfm);
nz("vifm","gtap11a") = card(vifm);
nz("vfm","gtap11a") = card(vfm);
...
nz("vst","abstol") = card(vst) - nz("vst","gtap11a");
nz("vtwr","abstol") = card(vtwr) - nz("vtwr","gtap11a");
nz("vxmd","abstol") = card(vxmd) - nz("vxmd","gtap11a");
nz("vdfm","abstol") = card(vdfm) - nz("vdfm","gtap11a");
nz("vifm","abstol") = card(vifm) - nz("vifm","gtap11a");
nz("vfm","abstol") = card(vfm) - nz("vfm","gtap11a");
...
nz("vst","reltol")  = card(vst)  - nz("vst","gtap11a")  - nz("vst","abstol");
nz("vtwr","reltol") = card(vtwr) - nz("vtwr","gtap11a") - nz("vtwr","abstol");
nz("vxmd","reltol") = card(vxmd) - nz("vxmd","gtap11a") - nz("vxmd","abstol");
nz("vdfm","reltol") = card(vdfm) - nz("vdfm","gtap11a") - nz("vdfm","abstol");
nz("vifm","reltol") = card(vifm) - nz("vifm","gtap11a") - nz("vifm","abstol");
nz("vfm","reltol")  = card(vfm)  - nz("vfm","gtap11a")  - nz("vfm","abstol");
...
nz(param,"%")  = round(100 * nz(param,"card")/nz(param,"gtap11a"));
option nz:0;
display nz;
