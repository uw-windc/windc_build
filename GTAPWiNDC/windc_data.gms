...
* household data:
$loaddc le0_ ke0_ tk0_ tl0_ cd0_h_ c0_h_ sav0_ hhtrn0_ pop0_
...
$call csv2gdx %file%  id=tave  useheader=yes index=1,2 values=5 output="%gams.scrdir%tave.gdx" trace=3
...
fsav0 = sum((r,g), i0(r,g)) - sum((r,h), sav0(r,h));
...
govdef0 = sum((r,g), g0(r,g)) + sum((r,h,trn), hhtrn0(r,h,trn))
	- sum(r, taxrevL(r)) 
	- taxrevK 
