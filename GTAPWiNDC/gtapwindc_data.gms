...
*	Define the national markets:

$if not defined mkt   set mkt /pooled/;
...
parameters
	...
	ns0(i,mkt,r,s)		National market supply
...
sets	y_(g,r,s)	Flag: Production
	...
	n_(i,mkt,r)	Flag: national market demand
...
gdp(r)$(not sameas(r,"usa")) = sum(s, sum(h,c0(r,s,h)) + vom("g",r,s) + vom("i",r,s)) - vb(r);
