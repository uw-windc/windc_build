$title	Read the steady-state dataset and replicate the dynamic baseline
...
$if not set ds $set ds soi_dynamic_gtap_census
...
*.govdef0 = - (	sum((r,g)$x_(r,g),x0(r,g)-rx0(r,g)) + 
*.		sum((r,g)$a_(r,g),rx0(r,g)-m0(r,g)) + 
*.		sum((r,h),trn0(r,h)) );
*.
parameter	pfxchk;
...
*.	e:PINV(r,t)		q:(sum(h,tl(r,h)*qref(t)*ke0(r,h)))	r:TAXRATE(t)
...
*.	e:PINV(r,t)		q:(-tl(r,h)*qref(t)*ke0(r,h))	r:TAXRATE(t)
	e:PKNYSE		q:ks0(r,h)
...
$offtext
$sysinclude mpsgeset dynamic_windc
...
KT.L(r,g) = 1;
TAXRATE.L(t) = 1;
dynamic_windc.workspace = 1000;
dynamic_windc.iterlim=0;
$include dynamic_windc.gen
solve dynamic_windc using mcp;
