$title	Read the State Annual GDP Data
...
$ifthen.gdxfile not exist sagdpcsv.gdx

$call csv2gdx i=sagdp\SAGDP1__ALL_AREAS_1997_2023  o=%gams.scrdir%t1.gdx id=v index=2,5 values=9..35 useheader=y >sagdp.log
$call csv2gdx i=sagdp\SAGDP2N__ALL_AREAS_1997_2023 o=%gams.scrdir%t2.gdx id=v index=2,5 values=9..35 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP3N__ALL_AREAS_1997_2022 o=%gams.scrdir%t3.gdx id=v index=2,5 values=9..34 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP4N__ALL_AREAS_1997_2022 o=%gams.scrdir%t4.gdx id=v index=2,5 values=9..34 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP5N__ALL_AREAS_1997_2022 o=%gams.scrdir%t5.gdx id=v index=2,5 values=9..34 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP6N__ALL_AREAS_1997_2022 o=%gams.scrdir%t6.gdx id=v index=2,5 values=9..34 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP7N__ALL_AREAS_1997_2022 o=%gams.scrdir%t7.gdx id=v index=2,5 values=9..34 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP8N__ALL_AREAS_1997_2023 o=%gams.scrdir%t8.gdx id=v index=2,5 values=9..35 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP9N__ALL_AREAS_1997_2023 o=%gams.scrdir%t9.gdx id=v index=2,5 values=9..35 useheader=y >>sagdp.log
$call csv2gdx i=sagdp\SAGDP11N__ALL_AREAS_1998_2023 o=%gams.scrdir%t11.gdx id=v index=2,5 values=9..34 useheader=y >>sagdp.log

$call gdxmerge %gams.scrdir%t*.gdx output=sagdpcsv.gdx
...
parameter	sagdp(s,id,yr,tbl)	State Annual GDP dataset;
sagdp(s,id,yr,tbl) = sum((s_r(s,r),id_row(id,row)),v(tbl,r,row,yr));
option sagdp:1:3:1;
display sagdp;

execute_unload 'sagdp.gdx',sagdp;
