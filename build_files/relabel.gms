...
$call cp "%reldir%%sep%windc_base.gdx" "%gams.scrdir%windc_base_.gdx"
...
sets  
  ...
  version_   "WiNDC version number"  /windc_2_1 "WiNDC 2.1"/;

*	Set compression to save file size:

$setenv GdxCompress 1
execute_unload '%reldir%%sep%windc_base.gdx', 
	version_=version,
	r_=r,
	sr_=sr,
	yr,
