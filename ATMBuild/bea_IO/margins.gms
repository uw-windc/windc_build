...
1 Industry Code These codes correspond to Input-Output detail codes
for industries.

2 Industry Description This is the description of the industry.

3 Commodity Code These codes correspond to Input-Output detail codes
for commodities.

4 Commodity Description This is the description of the commodity.

5 Producers' Value This is the producers' value (in millions of
dollars) of the commodity.

6 Transportation Costs This is the total transportation delivery cost
(in millions of dollars) of the commodity.

7 Wholesale This is the wholesale trade margin (in millions of
dollars) of the commodity.

The wholesale trade margin includes sales taxes and any state and
local excise taxes, and federal excise taxes collected by wholesalers.

8 Retail This is the retail trade margin (in millions of dollars) of
the commodity.

The retail trade margin includes sales taxes and any state and local
excise taxes, and federal excise taxes collected by retailers.

9 Purchasers' Value This is the purchasers' value (in millions of
dollars) of the commodity.
...
set	s	Industries /
	...
	333914	"Pump and pumping equipment manufacturing",
	...
	5241XX	"Insurance Carriers, except Direct Life Insurance",
...
set	c  Columns /
	"producer"	"Producers' value ($M)"
	"transport"	"Total transportation delivery cost ($M)"
	"wholesale"	"wholesale trade margin ($M)",
	"retail"	"Retail trade margin ($M)",
	"purchaser"	"Purchasers' value ($M)"/;
...
parameter	chk;
chk(m,yrs,s,g) = round(m(yrs,s,g,"producer") + sum(mrg,m(yrs,s,g,mrg)) - m(yrs,s,g,"purchaser"));
display chk;