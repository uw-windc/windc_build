$title	Gravity Estimation Routine

$if not set tradedata	$set tradedata ..\tradedata\aggtradedata.gdx
$if not set yr $set yr 2022

$set input	gravityinput_%yr%.gdx
$set output	gravityoutput_%yr%.gdx
