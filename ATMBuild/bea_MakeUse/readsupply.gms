...
$set wb		data\AllTablesSUP\Supply_2017_DET
$set gdxout	data\AllTablesSUP\supply.gdx
...
parameter	supply2007(r,c), supply2012(r,c), supply2017(r,c),
		supply(yr,r,c)  The BEA Domestic Supply of Commodities by Industries - (Millions of dollar) ;

$gdxin '%wb%.gdx'
$loaddc supply2007 supply2012 supply2017
supply("2007",r,c) = supply2007(r,c);
supply("2012",r,c) = supply2012(r,c);
supply("2017",r,c) = supply2017(r,c);

option r:0:0:1, c:0:0:1;
display r, c;

execute_unload '%gdxout%',supply,r,c;
