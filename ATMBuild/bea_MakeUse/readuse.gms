...
$set wb data\AllTablesSUP\Use_SUT_Framework_2017_DET
$set gdxout data\AllTablesSUP\use.gdx
...
set=r values=string rng=2007!a7..a417  rdim=1 cdim=0
par=use2007 rng=2007!a6..oo417 ignorecolumns=b rdim=1 cdim=1
par=use2012 rng=2012!a6..oo417 ignorecolumns=b rdim=1 cdim=1
par=use2017 rng=2017!a6..oo417 ignorecolumns=b rdim=1 cdim=1
$offecho
...
parameter  use(yr,r,c)  "BEA Use Table (Supply-Use Framework) [Millions of Dollars]";
