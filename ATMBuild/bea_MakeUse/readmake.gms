$title	Read the Make Tables for 2007-2012-2017

$set wb data\AllTablesIO\IOMake_After_Redefinitions_2017_Detail
$set gdxout data\AllTablesIO\make.gdx
...
par=make2007 rng=2007!a6..oo409 ignorecolumns=b rdim=1 cdim=1
par=make2012 rng=2012!a6..oo409 ignorecolumns=b rdim=1 cdim=1
par=make2017 rng=2017!a6..oo409 ignorecolumns=b rdim=1 cdim=1
$offecho
$if not exist %wb%.gdx $call gdxxrw i=%wb%.xlsx o=%wb%.gdx @%gams.scrdir%gdxxrw.rsp

set	yr /2007,2012,2017/;

parameter	make2007(r,c), make2012(r,c), make2017(r,c),
		make(yr,r,c)  The BEA Domestic Make of Commodities by Industries - (Millions of dollar) ;

$gdxin '%wb%.gdx'
$loaddc make2007 make2012 make2017
make("2007",r,c) = make2007(r,c);
make("2012",r,c) = make2012(r,c);
make("2017",r,c) = make2017(r,c);

option r:0:0:1, c:0:0:1;
display r, c;

execute_unload '%gdxout%',make,r,c;
