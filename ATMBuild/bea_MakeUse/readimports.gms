$title	Read the Import Tables for 2007-2012-2017

$set wb     data\ImportMatrices_After_Redefinitions_DET_2017
$set gdxout data\imports.gdx
...
par=imports2007 rng=2007!a6..pj408 ignorecolumns=b rdim=1 cdim=1
par=imports2012 rng=2012!a6..pj408 ignorecolumns=b rdim=1 cdim=1
par=imports2017 rng=2017!a6..pj408 ignorecolumns=b rdim=1 cdim=1
par=reconcile rng="Import Reconcilliation!a5..aa14" rdim=1 cdim=1
$offecho

$if not exist %wb%.gdx $call gdxxrw i=%wb%.xlsx o=%wb%.gdx @%gams.scrdir%gdxxrw.rsp
*.$call gdxxrw i=%wb%.xlsx o=%wb%.gdx @%gams.scrdir%gdxxrw.rsp

$gdxin '%wb%.gdx'

parameter	imports2007(r,c), imports2012(r,c), imports2017(r,c);
$loaddc imports2007 imports2012 imports2017

$ontext

Imports in the import matrix are valued at domestic port value, which
is the value of imports when they enter the U.S. economy. Domestic
port value is the substitution value of imports relative to
...
set	rc	Components of reconciliation /
"Total imports (use table)1"		"Totals for the use table come from the make-use framework where they are reported as negative values."
"Water freight"
"Air freight"
"Rail freight"
"Truck freight"
...
"Duties"
"Marine insurance"
"Total imports (import matrix) 2"	"Totals from the import matrix may differ from the sum of values in this table due to rounding." /;

set	yrs /1997*2022/;

parameter	reconcile(rc,yrs)	Reconciliation of Imports between the Use Table and Import Matrix [Millions of Dollars];
$loaddc reconcile
...
parameter  imports(yr,r,c)  "BEA Imports Table After Redefinitions Producers' Value [Millions of Dollars]";
imports("2007",r,c) = imports2007(r,c);
imports("2012",r,c) = imports2012(r,c);
imports("2017",r,c) = imports2017(r,c);
execute_unload '%gdxout%',imports,r,c,reconcile;
