$title	Read the Producer's Value Use Tables for 2007-2012-2017

$set wb data\AllTablesIO\IOUse_After_Redefinitions_PRO_2017_Detail
$set gdxout data\AllTablesIO\use_pro.gdx
...
set=r values=string rng=2007!a7..a414  rdim=1 cdim=0
par=use2007 rng=2007!a6..pk409 ignorecolumns=b rdim=1 cdim=1
par=use2012 rng=2012!a6..pk409 ignorecolumns=b rdim=1 cdim=1
par=use2017 rng=2017!a6..pk409 ignorecolumns=b rdim=1 cdim=1
$offecho
...
parameter	use2007(r,c), use2012(r,c), use2017(r,c);
$loaddc use2007 use2012 use2017

set	yr /2007,2012,2017/;

parameter  use(yr,r,c)  "BEA Use Table After Redefinitions Producers' Value [Millions of Dollars]";

use("2007",r,c) = use2007(r,c);
use("2012",r,c) = use2012(r,c);
use("2017",r,c) = use2017(r,c);
execute_unload '%gdxout%',use,r,c;
