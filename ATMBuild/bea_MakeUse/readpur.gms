$title	Read the Purchaser Price Use Tables for 2007-2012-2017

$set wb data\AllTablesIO\IOUse_After_Redefinitions_PUR_2017_DETAIL
$set gdxout data\AllTablesIO\use_pur.gdx
...
parameter  use(yr,r,c)  "BEA Use Table After Redefinitions Purchasers' Value [Millions of Dollars]";
